        ...
        >
          <v-card-text class="fill-height d-flex align-end">
            <v-row class="flex-column">
              <v-col>
                <v-btn color="accent" rounded>Travel</v-btn>
              </v-col>
          ...
          <div class="pt-16">
            ...
            <div>
              <v-row v-for="i in 6" :key="i" class="py-4">
                ...
                <v-col>
                  <div>
                    <v-btn depressed rounded color="accent">TRAVEL</v-btn>
                    ...
                    <p class="text-h6 font-weight-regular pt-3">
          ...
          <div>
            ...
            <div>
              <v-row v-for="i in 5" :key="i" class="py-4">
                ...
                <v-col>
                  <div>
                    <v-btn depressed rounded color="accent" small>TRAVEL</v-btn>
