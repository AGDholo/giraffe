...
Giraffe is a complete application theme, Giraffe theme built with [Vue](https://vuejs.org/) and [Tailwind CSS](https://tailwindcss.com/) created
...
**[View Live Preview](https://giraffe.vercel.app/)**

## Usage

### Basic Usage

Clone the source files of the theme and navigate into the theme's root directory. Run `bun install` and then run `bun run dev`
...
#### Scripts
We have now switched to the Vite build tool and Bun package manager, which is much faster.

- `bun run dev` start a vite dev server
- `bun run build` build all file to `dist`
...
Giraffe is an open source library of free Vue themes and templates。All of the free themes and templates on HeroUI
...
Giraffe theme created by [stackFlam1ngo](https://twitter.com/stackFlam1ngo).
